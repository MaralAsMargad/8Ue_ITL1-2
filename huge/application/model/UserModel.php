...
class UserModel
{
    ...
    public static function getPublicProfilesOfAllUsers()
    {
        ...
        foreach ($query->fetchAll() as $user) {
            ...
            $all_users_profiles[$user->user_id]->user_account_type = $user->user_account_type; // ITL12 - A7 Adding account_type to user profile
    ...
    //ITL12 - A7 Account Type Lang
    public static function getAccountTypeLang($type = null)
    {
        if (!$type) {
            return false;
        }
        ...
        $query = $db->prepare(
            "SELECT lang 
            FROM lang_user_account_type 
            WHERE account_type = :ac_type"
        );
    ...
    public static function getPublicProfileById($user_id)
    {
        $database = DatabaseFactory::getFactory()->getConnection();
